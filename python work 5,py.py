#recieved examples(didnt understand some of the code)
#5.1
car = 'subaru'
age = 25
temperature = 75
...
print(age < 18)
print("\nIs temperature == 75? I predict True.")
print(temperature == 75)
print("\nIs temperature != 75? I predict False.")
print(temperature != 75)
print("\nIs favorite_food == 'pizza'? I predict True.")
print(favorite_food == 'pizza')
print("\nIs favorite_food == 'burger'? I predict False.")
print(favorite_food == 'burger')
...
#5.8
usernames = ['admin', 'Jaden', 'Sophia', 'Liam', 'Olivia']
...
#5.10
current_users = ['Alice', 'Bob', 'Charlie', 'Diana', 'Evan']
new_users = ['bob', 'Frank', 'alice', 'Grace', 'Henry']
...
if alien_color == 'green':
    ...
    print("You earned 15 points.")
#5.13
# would like to make a simple game and see how this can be used statistically.