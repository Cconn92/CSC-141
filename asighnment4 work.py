...
print(cubes)
# 4.10
pizzas = ['pepperoni', 'cheese', 'deluxe', 'Hawaian', 'suasage']
...
for food in foods:
    print(food)
friend_foods = ['taco', 'salad', 'pasta', 'steak']
...
buffet_menu = ('pizza', 'taco', 'pasta', 'steak', 'cake')
...
#4.14
    def mypizzas():
        print("My Favorite Pizzas Are:")
pizzas = ['pepperoni','cheese','deluxe','suasage']
